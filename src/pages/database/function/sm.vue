<template>
    <div class="h-680 flex flex-col py-10 px-30">
        <div class="flex flex-row ml-1 my-7">
            <div class="text-4xl font-600">Secondary Metabolites Information</div>
...
type RowData = {
    ...
    type: string
    most_similar_known_cluster: string
    similarity: string
}
...
const createColumns = (): DataTableColumns<RowData> => [
    ...
    {
        title() {
            return renderTooltip(h('div', null, { default: () => 'Region' }), 'region')
        },
        key: 'region',
        align: 'center',
        width: 250,
    ...
    },
    {
        title() {
            return renderTooltip(
                h('div', null, { default: () => 'Most similar known cluster' }),
                'most similar known cluster'
            )
        },
        key: 'most_similar_known_cluster',
        align: 'center',
        sorter: 'default',
    },
    {
